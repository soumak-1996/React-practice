    ...
    return listResturant.length === 0 ? <Shimmer/> : (
        <div className="container-lg">
            <div className="w-96 px-[23px]">
                ...
                <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={searchResturant}> Search</button>
                </div>
            </div>
